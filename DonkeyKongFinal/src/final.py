...
while mainloop:
    ...
    display_game.blit(play, (displaysize[0] * 0.6, displaysize[1]
                      * 0.3))

    display_game.blit(exit, (displaysize[0] * 0.6, displaysize[1]
                      * 0.55))

    if displaysize[0] * 0.6 <= pygame.mouse.get_pos()[0] \
        <= displaysize[0] * 0.6 + 306 and displaysize[1] * 0.3 \
        <= pygame.mouse.get_pos()[1] <= displaysize[1] * 0.3 + 120:
        display_game.blit(play_glow, (displaysize[0] * 0.6,
                          displaysize[1] * 0.3))
            ...
            while True:
                ...
                if a[0] == True:
                    ...
                    while not game_status:
                        ...
                        overtext = \
                            over.render("Press 'q' to continue next level"
                                , 1, (255, 255, 255))
                        display_game.blit(scoretext,
                                (display_game.get_size()[0] * 0.6,
                                display_game.get_size()[1] * 0.3))
                        display_game.blit(overtext,
                                (display_game.get_size()[0] * 0.6,
                                display_game.get_size()[1] * 0.5))
                        pygame.display.flip()
                    ...
                    break
                i = i % numLevels + 1
    elif displaysize[0] * 0.6 <= pygame.mouse.get_pos()[0] \
        <= displaysize[0] * 0.6 + 306 and displaysize[1] * 0.55 \
        <= pygame.mouse.get_pos()[1] <= displaysize[1] * 0.55 + 120:

        display_game.blit(exit_glow, (displaysize[0] * 0.6,
                          displaysize[1] * 0.55))
        mousepress = pygame.mouse.get_pressed()
        if mousepress[0]:
            mainloop = False
