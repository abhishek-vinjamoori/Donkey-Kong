...
class board:
        ...
        for i in self.input_file:
            ...
            for j in i:
                ...
                if j == 'X':
                    ...
                    self.allladderposition.append([self.gap_x,
                            self.gap_y])
                    if temp == 'X' or i[iteration + 1] == 'X':
                        self.ladderposition.append([self.gap_x,
                                self.gap_y])
    ...
    def create_actor(self, name):
        if name == 'mario':
            self.mario = player(name, self.initPos[0], self.initPos[1],
                                self.finPos[0], self.finPos[1])
